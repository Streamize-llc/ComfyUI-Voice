...
def assets_dir() -> Path:
    # Vendored for ComfyUI-Voice: point at the downloaded model dir, which already
    # ships config.json / tokenizer.json / model.safetensors.index.json — avoids a
    # duplicate ~11MB tokenizer copy and any extra small-asset download.
    path = model_dir() / "higgs-audio-v3-tts-4b"
