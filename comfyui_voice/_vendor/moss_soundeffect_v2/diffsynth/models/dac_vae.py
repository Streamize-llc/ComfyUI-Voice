...
import torch
import tqdm
# Vendored ComfyUI-Voice: avoid the heavy descript-audiotools dependency.
# The generate/decode path needs only BaseModel.load + the AudioSignal name.
from ._audiotools_compat import AudioSignal
from ._audiotools_compat import BaseModel
